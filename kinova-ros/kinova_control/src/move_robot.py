...
def argumentParser(argument):
  ...
  # parser.add_argument('position_x', metavar='position_x', type=str, default='Home')
  # parser.add_argument('position_y', metavar='position_y', type=str, default='Home')
  # parser.add_argument('position_z', metavar='position_z', type=str, default='Home')
  ...
  # pos_x = int(args_.position_x)
  # pos_y = int(args_.position_y)
  # pos_z = int(args_.position_z)
